...
const ReferralSystem = () => {
  ...
  return (
    <Box>
      {/* Hero Section */}
      <Box bgGradient="linear(to-r, teal.500, teal.400)" color="white" py={10}>
          ...
          <VStack spacing={6} align="stretch">
            ...
            >
              <VStack spacing={4} align="stretch">
                <HStack>
                  <SafeIcon icon={FiLink} className="text-teal-500" />
            ...
            <Box bg="white" p={6} borderRadius="xl" shadow="md">
              <VStack spacing={4} align="stretch">
                <HStack>
                  <SafeIcon icon={FiMail} className="text-teal-500" />
            ...
            <Box bg="white" p={6} borderRadius="xl" shadow="md">
              <VStack spacing={4} align="stretch">
                <HStack>
                  <SafeIcon icon={FiShare2} className="text-teal-500" />
              ...
              <VStack spacing={4} align="stretch">
                ...
                <List spacing={3}>
                  {rewardTiers.map((tier, index) => (
                    <ListItem key={index}>
                      <HStack p={4} bg="gray.50" borderRadius="md" justify="space-between">
                        ...
                        <Badge colorScheme={referralStats.completed >= tier.count ? "green" : "gray"}>
